...
```{r wordcloud_nombres_preparacion}
...
Obtenemos un acierto del 60%, al que hay que sumar otros 12 pacientes. 
### Si añadimos estos pacientes, nos encontramos con un acierto del 77%
Por lo tanto, SVM de Kernel radial es una buena técnica para la predicción en este problema.
