...
for(i in 1:20)
{
  pacientes.1neu <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=1, trace = F)
...
for(i in 1:20)
{
  pacientes.1neu.softmax <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=1, softmax = T , trace = F)
...
for(i in 1:20)
{
  ...
  pacientes.2neu <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=2, trace = F )
...
for(i in 1:20)
{
  ...
  pacientes.2neu.softmax <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=2, softmax = T, trace = F )
...
for(i in 1:20)
{
  ...
  pacientes.3neu <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=3, trace = F)
...
for(i in 1:20)
{
  ...
  pacientes.3neu.softmax <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=3, softmax = T, trace = F)
...
for(i in 1:20)
{
  ...
  pacientes.3neu.decay <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=3, decay = 0.2, trace = F)
...
for(i in 1:20)
{
  ...
  pacientes.3neu.decay.softmax <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=3, softmax = T, decay = 0.03, trace = F)
...
for(i in 1:20)
{
  ...
  pacientes.5neu <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=5, trace = F )
...
for(i in 1:20)
{
  ...
  pacientes.5neu.softmax <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=5, softmax = T, trace = F )
...
for(i in 1:20)
{
  ...
  pacientes.5neu.decay <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=5, decay=0.1, trace = F)
...
for(i in 1:20)
{
  ...
  pacientes.5neu.decay.softmax <- nnet( matriz.pacientes.datos.centscal[conjuntoEntrenamiento, 1:24], class.ind( matriz.pacientes.etiquetas[conjuntoEntrenamiento, 25] ) , size=5, softmax = T, decay = 0.05, trace = F)
...
```{r export_PDF_resultados_RF_centscal}
...
```{r ROC_RandomForest_Centscal}

rf.roc.centscal<-multiclass.roc(as.factor(dataset$grupo), model_centscal$votes[,2])
auc(rf.roc.centscal)
...
```{r export_PDF_results_RF_Corrected}
...
```{r ROC_RandomForest_new}

rf.roc.new<-multiclass.roc(as.factor(dataset$grupo), model_new$votes[,2])
auc(rf.roc.new)
...
modelo_svm.radial.cv <- svm(matriz.pacientes.datos.centscal, as.factor(dataset[, 26]), kernel="radial", cross = 5)
summary(modelo_svm.radial.cv)
...
```{r prediccionYAcierto_SVM_CV}

set.seed(5)

prediccion.radial.cv <- predict(modelo_svm.radial.cv, matriz.pacientes.datos.centscal)
...
```{r export_PDF_dendrograma_centscal, results='hide', echo=T}
...
```{r calculo_numero_optimo_clusters}

datos.kmeans <- matriz.pacientes.datos # Sin la clasificación dentro del dataset

fviz_nbclust(datos.kmeans, kmeans, method = "wss")

```

Como podemos ver, en el momento en el que dobla el codo es aproximadamente entre el 3 y el 4, por lo que nuestra elección de 4 clusters es correcta.

Exporto esto a PDF:

```{r export_PDF_numberClusters}
...
Para esto usaremos la librería RWeka, que es la implementación en R de Weka.
Como matriz de inicio, usaremos la matriz.pacientes.datos, que está ya limpia.
...
part_sex <- PART(sex~., data = matriz.pacientes.datos.rm, control = Weka_control(C = 0.5))
...
part_imp <- PART(impuls~., data = matriz.pacientes.datos.rm, control = Weka_control(C = 0.5))
...
part_agr <- PART(agres~., data = matriz.pacientes.datos.rm, control = Weka_control(C = 0.5))
...
part_gru <- PART(`dataset$grupo`~., data = matriz.pacientes.datos.rm, control = Weka_control(C = 0.5))
